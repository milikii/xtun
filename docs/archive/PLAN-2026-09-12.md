...
> **历史归档：** 本文保存 2026-09-12 的规划入口及当时判断。T01、CI 和部分实机修复随后已完成，本文不再代表当前状态或下一施工项。
> 2026-09-13 归档时仅调整相对链接并增加此说明；当前入口见 [PLAN](../PLAN.md)，新施工顺序见 [交互与可靠性推进计划](../PLAN-UX-RELIABILITY.md)。
...
历史设计归档在 [1.1.0 施工图](PLAN-1.1.0.md) 与 [1.0.0 施工图](PLAN-1.0.0.md)。旧计划的历史决策不整体继承；与新版本冲突时，以当前代码及本文为准。
